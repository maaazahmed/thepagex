    ...
    return (
        <Container>
            ...
            <div className="ratio">
                ...
                {/* <button onClick={() => setRatio(16 / 16)}>16/16</button> */}
                {/* <button onClick={() => setRatio(9 / 9)}>9/9</button> */}
                {/* <button onClick={() => setRatio(4 / 4)}>4/4</button> */}
                {/* <button onClick={() => setRatio(3 / 3)}>3/3</button> */}
                <button onClick={() => setRatio(1 / 1)}>1/1</button>
                {/* <button onClick={() => setRatio(5 / 5)}>3/4</button> */}
            </div>
        </Container>
    )
}
