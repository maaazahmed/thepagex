    ...
    return (
      <Wrapper>
        <div className="top-card">
          <img
            src={"http://167.172.166.24:3000" + "/" + this.props.photo}
          ...
          <div className="info-top-card">
            <div>
              ...
              <p className="info-hour">{this.props.hour}</p>
            </div>
        ...
        <div className="card-btn">
          <Link
            className="card-btn-item"
            to="#"
            onClick={this.handleShowPromote}
          >
            Promote
          </Link>
          <Link className="card-btn-item" to="#" onClick={this.handleShowReact}>
            React
          </Link>
        </div>
        {showReactPost}
